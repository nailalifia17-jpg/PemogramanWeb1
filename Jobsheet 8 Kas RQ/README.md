# SIM Kas Yayasan RQ - Jobsheet 8

Versi ini mempertahankan alur dan tampilan SIM Kas Yayasan RQ, tetapi penyimpanan data sudah dipindahkan dari session PHP ke PostgreSQL menggunakan PDO prepared statement.
